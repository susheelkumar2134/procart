...
//     var a= document.getElementById('searchClose');
...
// document.getElementById('productall').innerHTML= p.join(" ");
...
export {changeColor,changeColorText,toggle,crossmenu,menu_x,userMenu};
